...
def main():
    ...
    # YOLOv26 Specific optimizations (NMS-Free & MuSGD Optimizer)
    if "yolo26" in args.model.lower():
        print("STATUS: YOLOv26 detected. Applying NMS-Free and MuSGD optimizations...")
        # MuSGD is a hybrid optimizer designed for YOLOv26's convergence
        train_config["optimizer"] = "MuSGD"
        # Adjusted loss gains for Progressive Loss Balancing (ProgLoss)
        train_config["box"] = 7.5 
        train_config["cls"] = 0.5
        train_config["dfl"] = 1.5
