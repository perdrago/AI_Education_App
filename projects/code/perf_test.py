...
print("Loading V26...")
# Check if V26 exists, fallback to V11 if not
v26_path = 'projects/model/V26.onnx'
if os.path.exists(v26_path):
    s_v26 = ort.InferenceSession(v26_path, providers=providers)
else:
    print(f"WARN: {v26_path} not found, using V11 as fallback.")
    s_v26 = s_v11
...
sessions = [s_v8, s_v11, s_v26]
names = ["V8", "V11", "V26"]
cur = 0
fc, t0 = 0, time.perf_counter()

print(f"[OK] Active: {names[cur]} {gpu_tag} | Ctrl+1/2/3 to switch")
